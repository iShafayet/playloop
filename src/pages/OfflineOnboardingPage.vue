    ...
    <q-card class="onboarding-card">
      ...
      <q-card-section v-if="currentStep === 1" class="step-content">
        <div class="welcome-section">
          ...
          <q-banner class="bg-green-1 text-green-9 q-mb-lg" rounded>
            ...
            <div class="text-body1">You've chosen Playloop, the gaming tracking app that helps you track and plan your gaming like never before.</div>
          </q-banner>

          <!-- How Playloop Works -->
          <div class="info-section q-mb-lg">
            <div class="text-h6 q-mb-md">How Playloop Works</div>

            <div class="feature-list">
              <div class="feature-item q-mb-md">
                <q-icon name="sports_esports" size="24px" color="primary" class="q-mr-sm" />
                <div>
                  <div class="text-subtitle1">Track Your Games</div>
                  <div class="text-body2 text-grey-7">Manage your game library, track playtime, and monitor your gaming sessions</div>
                </div>
              </div>
              ...
              <div class="feature-item q-mb-md">
                ...
                <div>
                  <div class="text-subtitle1">Gaming Analytics</div>
                  <div class="text-body2 text-grey-7">Get detailed insights about your playtime, favorite platforms, and gaming habits</div>
                </div>
              </div>
      ...
      <q-card-section v-if="currentStep === 2" class="step-content">
        <div class="username-section">
          ...
          <div class="text-body2 text-grey-7 q-mb-lg">This will be your identifier within Playloop.</div>
      ...
      <q-card-section v-if="currentStep === 3" class="step-content">
        <div class="setup-section">
          ...
          <template v-if="setupComplete">
            ...
            <div class="text-body2 text-grey-7 q-mb-lg">You can now start using Playloop.</div>
          </template>
          ...
          <div v-if="setupComplete" class="setup-complete">
            <q-banner class="bg-green-1 text-green-9 q-mb-lg" rounded>
              ...
              <div class="text-body1"><strong>Setup Complete!</strong> Your Playloop account is ready to use.</div>
            </q-banner>
            ...
            <div class="completion-summary q-mb-lg">
              ...
              <div class="summary-grid">
                <div class="summary-item">
                  <q-icon name="devices" color="blue" />
                  <span>10 game platforms</span>
                </div>
                <div class="summary-item">
                  <q-icon name="sports_esports" color="purple" />
                  <span>Ready to track games</span>
                </div>
                <div class="summary-item">
                  <q-icon name="play_circle" color="orange" />
                  <span>Session tracking ready</span>
                </div>
              </div>
            </div>
          </div>
