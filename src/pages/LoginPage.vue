<template>
  <q-page class="row items-center justify-evenly">
    <q-card class="login-card">
      <div class="app-name q-pa-xs"><img class="logo" src="icons/logo.png" alt="PL" />Playloop</div>
      ...
      <template v-if="loginPageMode === 'login'">
        ...
        <q-card-section v-if="currentStep === 1" class="offline-trial-section">
          ...
          <div class="text-center q-mb-md">
            ...
            <div class="text-body2 text-grey-7">Start using Playloop immediately with unlimited offline access</div>
          </div>
