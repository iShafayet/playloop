  ...
  <q-page class="row items-start justify-evenly">
    <q-card class="std-card">
      <div class="title-row q-pa-md q-gutter-sm">
        <div>
          <div class="title">Playloop</div>
          <div style="margin-top: 8px">Track and plan your gaming like never before!</div>
          <div style="margin-top: 8px">This Free and OpenSource Software (FOSS) is developed and maintained by Sayem Shafayet.</div>

          <div style="margin-top: 8px">
            Source Code: <a href="https://github.com/iShafayet/playloop" target="_blank">Under GPL-3.0 license on GitHub</a>.
          </div>
